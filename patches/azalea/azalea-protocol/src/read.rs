...
// Increased from 2MB to 64MB for heavily modded NeoForge servers
// (DynamicOdyssey 2.26.0 sends ~25MB registry sync packets)
pub static MAXIMUM_UNCOMPRESSED_LENGTH: u32 = 67_108_864;
